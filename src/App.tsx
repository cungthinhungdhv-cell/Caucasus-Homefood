...
const translations = {
  ru: {
    ...
    operationalExpensesTooltip: 'Аренда + Маркетинг + Коммунальные + Непредвиденные',
  ...
  vi: {
    ...
    operationalExpensesTooltip: 'Thuê + Marketing + Điện nước + Chi phí phát sinh',
...
function App() {
  ...
  const saveValues = () => {
    const values = {
      ...
      rent, marketing, utilities, contingency,
      vat, incomeTax,
  ...
  const calculations = useMemo(() => {
    ...
    // Operational costs
    const operationalTotal = rent + marketing + utilities + contingency
